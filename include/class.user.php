...
class user
{
     ...
     */
    function add($name, $email, $company, $pass, $locale = "", $tags = "", $rate = 0.0, $designation, $gradelevel, $employmentdate, $dob)
    {
		...
		$gradelevel = mysql_real_escape_string($gradelevel);
        $rate = (float) $rate;

        $pass = sha1($pass);

        $ins1 = mysql_query("INSERT INTO user (name,email,company,pass,locale,tags,rate,designation, gradelevel) VALUES ('$name','$email','$company','$pass','$locale','$tags','$rate','$designation','$gradelevel')");
     ...
     * @return bool
     */
    function edit($id, $name, $realname, $email, $tel1, $tel2, $company, $zip, $gender, $url, $address1, $address2, $state, $country, $tags, $locale, $avatar = "", $rate = 0.0, $designation, $gradelevel, $employmentdate, $dob, $disengagementdate, $exammonitor)
    {
        $name = mysql_real_escape_string($name);
        ...
        if ($avatar != "")
        {
            $upd = mysql_query("UPDATE user SET name='$name',email='$email',tel1='$tel1', tel2='$tel2',company='$company',zip='$zip',gender='$gender',url='$url',adress='$address1',adress2='$address2',state='$state',country='$country',tags='$tags',locale='$locale',avatar='$avatar',rate='$rate', designation='$designation', gradelevel='$gradelevel' WHERE ID = $id");
        }
        else
        {
            $upd = mysql_query("UPDATE user SET name='$name',email='$email', tel1='$tel1', tel2='$tel2', company='$company',zip='$zip',gender='$gender',url='$url',adress='$address1',adress2='$address2',state='$state',country='$country',tags='$tags',locale='$locale',rate='$rate', designation='$designation', gradelevel='$gradelevel' WHERE ID = $id");
        }
        if ($upd)
        {
