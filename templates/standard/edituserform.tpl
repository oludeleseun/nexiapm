	...
	<div class="message">
		<div class="block">
			<table cellpadding="0" cellspacing="0" border="0">
						...
						<td class="right">
							<select name = "company" realname = "{#company#}" required="1" exclude = "-1" id = "company">
                                ...
                                {section name = company loop=$companies}
                                    <option value = "{$companies[company].ID}" id="role{$companies[company].ID}" {if $companies[company].ID == $user.company}selected="selected"{/if}>{$companies[company].name}</option>
                                {/section}
                            </select>
						</td>
					</tr>
                ...
                <tbody class="color-b">
					<tr>
						<td><label for = "company">{#designation#}:</label></td>
						<td class="right">
                ...
                <tbody class="color-b">
					<tr>
						<td><label for = "company">{#gradelevel#}:</label></td>
						<td class="right">
							<input type = "text" name = "gradelevel" id = "gradelevel" value = "{$user.gradelevel}" />
						</td>
					</tr>
				</tbody>
                ...
                <tbody class="color-a">
                    <tr>
                        ...
                        <td class="right"><input type = "text" class="text" value = "{$user.dob}" name = "dob" id="dob"  />
                    </td>
                    </tr>
                </tbody>
                ...
                <tbody class="color-b">
                    <tr>
                        <td><label for="employmentdate">{#employmentdate#}:</label></td>
                        <td class="right"><input type = "text" class="text" value = "{$user.employmentdate}" name = "employmentdate" id="employmentdate" />
                    </td>
                    </tr>
                </tbody>
                ...
                <tbody class="color-a">
                    <tr>
                        <td><label for="disengagementdate">{#disengagementdate#}:</label></td>
                        <td class="right"><input type = "text" class="text" value = "{$user.disengagementdate}" name = "disengagementdate" id="disengagementdate" /></td>
                    </tr>
                </tbody>
                
                <tbody class="color-b">
                    <tr>
                        <td><label for="exammonitor">{#exammonitor#}:</label></td>
                        <td class="right"><input type = "text" class="text" value = "{$user.exammonitor}" name = "exammonitor" id="exammonitor" /></td>
                    </tr>
                </tbody>
