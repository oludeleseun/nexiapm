<div class="block_in_wrapper">
	...
	<fieldset>
	  ...
	  <input type = "hidden" name = "project" value = "{$project.ID}" />
        ...
        <div class= "row"><label for="ended">{#estimatedHours#}:</label><input type="text" class="text" name="estimatedHours" id="estimatedHours" required="1" realname="{#estimatedHours#}" /></div>
