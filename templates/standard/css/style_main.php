...
#mainmenue .submen li.company-settings a {
	background: url(../images/company-settings.png) no-repeat 0 0;
}
...
.user .moreinfo a, .projects .project .moreinfo a, .tasks .morinfo a {
...
.projects .company .datepick td.today, .tasks .datepick td.today, .miles .datepick td.today, .timetrack .datepick td.today, .neutral .datepick td.today {
	color: <?php echo $green;
?>;
	background: url(../images/color-c-green.png) repeat 0 0;
}

.projects .company .datepick td.red, .tasks .datepick td.red, .miles .datepick td.red, .timetrack .datepick td.red, .neutral .datepick td.red {
	color: <?php echo $red;
?>;
	background: url(../images/color-c-red.png) repeat 0 0;
}
...
.projects .company .datepick td.next a {
	background-image: url(../images/next-side-projects.png);
}
.projects .company .datepick td.back a {
...
ul.tabs li.company a {
	background-image: url(../images/symbols/tab-company.png);
}
...
.company .headline, .company a.butn_link, .company button, .company a.butn_link_active:hover, .company .inmenue a span, .company .moreinfo {
	background: <?php echo $projectsBlockhead;
?>;
}
...
.company .second-thead, .company .second-thead:hover td, .company .block_in_wrapper, .company .inwrapper li:hover, .company .tableend, .company .statuswrapper li.link:hover {
	background: <?php echo $projectsTableSecondhead;
?>;
}

.company .color-a, .company .statuswrapper li, .company .datepick table td, .company .datepick tr.head td {
	background: <?php echo $projectsColorA;
?>;
}

.company .color-b, .company .datepick td.wrong, .company .datepick tr.weekday td {
	background: <?php echo $projectsColorB;
?>;
}

.company .block, .company a, .company h1, .company .block .tablemenue, .company .block .addmenue, .company p.tags-miles {
	border-color: <?php echo $projectsMain;
?>;
	color: <?php echo $projectsMain;
?>;
...
.company, .company .block td.finished, .company .block td.finished a, .company .datepick .cal, .company .block_in_wrapper h2 {
	color: <?php echo $projectsMain;
?>;
}

.company h1 span, .company h1 span a, .company .status, .company .statusbar, .company .statusbar_b {
	color: <?php echo $projectsB;
?>;
	border-color: <?php echo $projectsB;
?>;
...
.company form, .company form input, .company form select, .company form textarea, .company form .row .editor, .company .statuswrapper li {
	border-color: <?php echo $projectsB;
?>;
	color: <?php echo $projectsMain;
?>;
...
.company a.butn_link:hover, .company button:hover, .company form .fileinput:hover button, .company a.butn_link_active, .company .datepick .picker {
	background: <?php echo $projectsC;
?>;
}
/* TASKS COLORS #####################################*/
